  ...
  return (
    <div>
      <div className="flex items-center justify-center h-screen">
        <div className="card w-80 rounded-3xl h-84 p-7 bg-gradient-to-b from-slate-800 to-slate-950 text-white">
          ...
          <button className="p-2 rounded-3xl w-full bg-orange-500 mt-4 hover:bg-white hover:text-orange-500">
            SUBMIT
          </button>
        </div>
      </div>
